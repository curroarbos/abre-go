...
Activity.create(title: "Guitar Lesson", user: User.first, category: Category.second, price: 99, in_house: true, location: LOCATIONS.sample, max_people: 5, photo_url: "https://as2.ftcdn.net/v2/jpg/02/87/24/95/1000_F_287249541_Ui4Iqyp4ggPSuHg89yvvEWsB4ksH9jYT.jpg")
...
Activity.create(title: "Pool Party", user: User.fifth, category: Category.second, price: 499, in_house: true, location: LOCATIONS.sample, max_people: 15, photo_url: "https://images.unsplash.com/photo-1528495612343-9ca9f4a4de28?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
Activity.create(title: "Laundry Service", user: User.first, category: Category.fifth, price: 5, in_house: true, location: LOCATIONS.sample, max_people: 1, photo_url: "https://images.unsplash.com/photo-1567113463300-102a7eb3cb26?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
Activity.create(title: "Dj set", user: User.first, category: Category.second, price: 200, in_house: true, location: LOCATIONS.sample, max_people: 15, photo_url: "https://images.unsplash.com/photo-1571266028243-d220c6a7edbf?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
Activity.create(title: "Nany at home", user: User.second, category: Category.fifth, price: 80, in_house: true, location: LOCATIONS.sample, max_people: 3, photo_url: "https://images.unsplash.com/photo-1594950981383-6eb659d18fbf?q=80&w=2669&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
...
Activity.create(title: "Jungle Camping", user: User.fifth, category: Category.fourth, price: 200, in_house: false, location: LOCATIONS.sample, max_people: 6, photo_url: "https://images.unsplash.com/photo-1526011881888-8dba3f788ede?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8anVuZ2xlJTIwY2FtcGluZ3xlbnwwfHwwfHx8Mg%3D%3D")
