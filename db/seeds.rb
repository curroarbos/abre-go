...
Activity.create(title: "Nany at home", user: User.second, category: Category.fifth, price: 80, location: LOCATIONS.sample, max_people: 3, photo_url: "https://images.unsplash.com/photo-1594950981383-6eb659d18fbf?q=80&w=2669&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
Activity.create(title: "Cooking Class", user: User.third, category: Category.first, price: 100, location: LOCATIONS.sample, max_people: 8, photo_url: "https://images.unsplash.com/photo-1519671282429-b44660ead0a7?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
